...
const ResultModal = ({ searchedKeyword, searchedLocation }: { searchedKeyword: string, searchedLocation: string }): ReactElement => {
    return (
        <div className="mx-[auto] sm:mx-0 w-[60%] sm:w-[80%] my-4 flex flex-col sm:flex-row justify-between items-center p-4 sm:p-6 shadow-md rounded    shadow-neutral-500/50">
